...
// Vendored from nyblnet/bento, path slides/src/sync/crdt.ts, pinned at commit
// a7f2e83aeabc75f03f5fb4cdd7b234d47cfa5324. Adapted only for local resolution:
// the upstream kernel import path is rewritten to the vendored ./crdt.js.
...
import { SyncEngine, shape } from './crdt.js'
import type { DocShape } from './crdt.js'
