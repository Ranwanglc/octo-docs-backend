...
//
// Vendored from nyblnet/bento, path kernel/src/sync/crdt.ts, pinned at commit
// a7f2e83aeabc75f03f5fb4cdd7b234d47cfa5324. This is a byte-faithful copy of the
// upstream engine: do not edit it locally — to pick up upstream changes,
// re-vendor from that commit (or a newer pin) rather than patching in place.
// The sync format version SYNC_V declared in this file MUST stay aligned with
// the backend's BENTO_SYNC_V (both are 2); bumping one without the other forks
// persisted state from the wire format.
/* eslint-disable */
// @ts-nocheck
